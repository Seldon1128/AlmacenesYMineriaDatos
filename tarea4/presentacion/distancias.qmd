...
```{python}
print("--- Sin escalar ---")
print(f"Distancia entre A y B: {distancia_euclideana(cliente_a, cliente_b):.1f}")
print(f"Distancia entre A y C: {distancia_euclideana(cliente_a, cliente_c):.1f}")
```
...
2. ¿Qué pasa en el caso de Gower si dos objetos son idénticos en todas las variables continuas pero difieren en una categórica?
...
3. ¿Cómo se relaciona la multidimensionalidad con la distancia euclideana y la manhattan?

[ver más](https://bib.dbvis.de/uploadedFiles/155.pdf)
